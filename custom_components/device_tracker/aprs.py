"""
Device tracker platform that adds support for the Amateur Packet Reporting
Service. For more information, visit http://www.aprs.org .

Modified from the Owntracks/MQTT component.
"""
import asyncio
import base64
import json
...
CONF_MAX_GPS_ACCURACY = 'max_gps_accuracy'          # the part in quotes comes from configuration.yaml
CONF_SECRET = 'secret'
